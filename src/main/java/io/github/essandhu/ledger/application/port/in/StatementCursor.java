 ...
 * already seen (PLAN §5). The next page contains only lines strictly after it in
 ...
 * entries by construction (PLAN §4.6). Value object only: the opaque wire encoding, and its
